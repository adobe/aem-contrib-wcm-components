...
import com.adobe.cq.wcm.contrib.components.marketo.StaticResponseMarketoClient;
...
public class TestMarketoClient {
  ...
  @BeforeEach
  public void init() {
    context.addModelsForPackage("com.adobe.cq.wcm.contrib.components.models.marketo");
    context.addModelsForPackage("com.adobe.cq.wcm.contrib.components.internal.models.marketo");
