...
@Model(adaptables = SlingHttpServletRequest.class, resourceType = DemoComponent.RESOURCE_TYPE, adapters = {ContainerExporter.class,ComponentExporter.class, ResponsiveGridExporter.class})
