/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
package com.adobe.cq.wcm.contrib.components.marketo;
...
public interface MarketoClient {
   ...
   */
  public @NotNull List<MarketoForm> getForms(@NotNull MarketoClientConfiguration config) throws IOException;
   ...
   * @throws IOException an exception occurs interacting with the API
   */
  public @NotNull List<MarketoField> getFields(@NotNull MarketoClientConfiguration config) throws IOException;
