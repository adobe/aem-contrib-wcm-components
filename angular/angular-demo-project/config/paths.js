...
const clientLibPath = '/apps/contrib/wcm/clientlibs/clientlib-site-angular/resources';
...
module.exports = {
    ...
    publicPath: '/etc.clientlibs/contrib/wcm/clientlibs/clientlib-site-angular/resources/',
